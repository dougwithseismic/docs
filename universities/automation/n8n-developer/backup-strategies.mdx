...
<CardGroup cols={2}>
  <Card title="Error Handling" href="./error-handling" icon="shield-halved">
    Handle failures gracefully
  </Card>
  <Card title="Performance Optimization" href="./performance-optimization" icon="rocket">
    Scale n8n effectively
  </Card>
</CardGroup>
