...
- Learn [n8n Basics](/universities/automation/no-code/n8n-basics) if you're getting started
- Explore [LLM Workflow Generation](/universities/automation/no-code/n8n-llm-workflow-generation) for AI-powered automation