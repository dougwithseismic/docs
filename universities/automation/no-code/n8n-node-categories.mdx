...
- Explore the [Complete Node List](/universities/automation/no-code/n8n-complete-node-list) for all available nodes
- Learn [n8n Basics](/universities/automation/no-code/n8n-basics) if you're just getting started