...
<script type="application/ld+json">
  ...
  "url": "https://withseismic.com/approach/ongoing-optimization",
  "step": [
    {
      "@type": "HowToStep",
      "position": 1,
...
<Info>
  **What happens after you build the first tool?** Building is just the start.
  Real transformation happens when your entire team adopts automation,
  eliminating repetitive work across all workflows with smooth deployment and
  rapid adoption.
</Info>
...
<Info>
  **How long does it take to train my team on new tools?** Our tools require
  just 10-minute training sessions per team member. Everyone runs their first
  automation successfully, and excitement builds as grunt work disappears.
</Info>
...
<Info>
  **Can our internal tools become products for clients?** After 3 months of
  internal success with proven time savings, we assess which tools clients would
  pay for and develop productization strategy with go-to-market planning.
</Info>
...
<Info>
  **What's the typical ROI for automation projects?** 2-Week Sprint ($12K) pays
  back in 1 month with 1,100% first-year ROI. 4-Week Sprint ($25K) pays back in
  2 months with 476% first-year ROI and ongoing $144K annual savings.
</Info>
...
<Card
  ...
  href="/quickstart"
>
  Book our 2-week sprint ($12K) or 4-week sprint ($25K) to eliminate repetitive
  work forever. See ROI in week 1, transformation in month 1.
</Card>

## Frequently Asked Questions

<AccordionGroup>
  <Accordion title="What happens after you build our first automation tool?">
    Building is just the start. Real transformation happens when your entire team adopts automation across all workflows. We ensure smooth deployment, rapid adoption, and systematic scaling to eliminate repetitive work company-wide.
  </Accordion>

  <Accordion title="How long does it take to train our team on the new tools?">
    Our tools require just 10-minute training sessions per team member. Everyone runs their first automation successfully, and excitement builds as grunt work disappears. If training takes longer, we've failed our design goals.
  </Accordion>

  <Accordion title="What's the typical ROI for automation projects?">
    2-Week Sprint ($12K) pays back in 1 month with 1,100% first-year ROI. 4-Week Sprint ($25K) pays back in 2 months with 476% first-year ROI and ongoing $144K annual savings from 40 hours saved weekly.
  </Accordion>

  <Accordion title="How do you scale automation across our entire organization?">
    We start with one successful tool, then expand systematically: Week 2-4 (optimization & expansion), Month 2-3 (scaling across teams), with department-wide adoption and cross-team integration that breaks down silos.
  </Accordion>

  <Accordion title="Can our internal tools eventually become products for clients?">
    After 3 months of internal success with proven time savings, we assess which tools clients would pay for and develop productization strategy with go-to-market planning. Many internal tools become revenue-generating products.
  </Accordion>

  <Accordion title="What kind of ongoing support do you provide?">
    Slack/email support channel, bug fixes within 24 hours, feature requests tracked, regular check-ins, monthly optimization reviews, performance monitoring, security updates, and new integration opportunities.
  </Accordion>

  <Accordion title="How do you measure success after deployment?">
    Month 1: 20+ hours/week saved, 50% reduction in grunt work, 30% faster project delivery. Month 3: 2x client capacity, 40% margin improvement, 50% less overtime, 80% happier team, and automation-first mindset.
  </Accordion>

  <Accordion title="What's the long-term transformation we can expect?">
    Year 1 evolution from service company to systems company: Months 1-3 (internal revolution), Months 4-6 (client impact), Months 7-12 (market positioning with productized offerings and competitive advantage).
  </Accordion>

  <Accordion title="How do you ensure our team actually adopts the automation?">
    Success breeds appetite for more. Teams suggest what to automate next, we build on existing infrastructure for compound efficiency gains. Culture transforms to 'Can we automate this?' as the default question.
  </Accordion>

  <Accordion title="What's the path from automation to exponential business growth?">
    Before: Trading time for money with linear growth limited by headcount. After: Building systems that scale with exponential growth through automation. Team energized by creative challenges instead of burned out on repetitive work.
  </Accordion>
</AccordionGroup>
