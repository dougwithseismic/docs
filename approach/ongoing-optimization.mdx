...
<Card title="Scale Your Productized Tools" icon="rocket" href="/quickstart">
  Book Doug's 2-week sprint ($6K) or 4-week sprint ($12K) to build and optimize your productized tools. 4-hour response time for immediate optimization planning.
</Card>