...
<AccordionGroup>
  <Accordion title="What's the difference between 2-week and 4-week sprints?">
    2-Week Sprint ($12K) builds one tool that eliminates a major time sink, perfect for testing our approach. 4-Week Sprint ($25K) transforms entire workflows with 2-3 connected tools and LLM integration for complete process elimination.
  </Accordion>
