...
<Card title="Start Your First Sprint" icon="play" href="https://calendly.com/withseismic/sprint-planning">
  Schedule a sprint planning session to define your first development cycle and begin building your productized tools.
</Card>