...
<Info>
  **The browser paradox**: Your team lives in their browsers 6+ hours daily, yet browsers remain dumb display tools. Extensions turn passive viewing into active value creation.
</Info>
...
<Warning>
  **Indy.ai Case Study**: We turned Contra's user base into a distributed data collection network. 20,000 users creating value for each other while they browse.
</Warning>
...
<Tabs>
  <Tab title="The Problem">
    ...
    Contra needed job inventory but couldn't scrape LinkedIn at scale. Traditional scraping would violate terms of service and hit rate limits.
  </Tab>
  <Tab title="The Solution">
    <Icon icon="lightbulb" />
    Transform users into distributed collectors. Each user's browsing contributes to everyone's benefit through LLM-powered opportunity identification.
  </Tab>
  <Tab title="The Magic">
    <Icon icon="wand-magic-sparkles" />
    - Each user covers their unique network
    - 20,000 users = 20,000 perspectives
...
<Check>Result: 20,000+ users achieved organically through Chrome Web Store optimization</Check>
...
<CardGroup cols={3}>
  <Card title="Contra: Marketplace" icon="briefcase">
    **Before**: Limited inventory
    **After**: 5x in 2 weeks
    **Cost**: One-time dev
    **Value**: Moat created
  </Card>
  <Card title="GrowthRunner: Ops" icon="chart-line">
    **Before**: Hours per audit
    **After**: Minutes, 100% accurate
...
<AccordionGroup>
  <Accordion title="Identify Browser Workflows">
    Map where your team spends time in browsers. What sites do they visit repeatedly? What manual tasks do they perform?
  </Accordion>
  <Accordion title="Design Value Injection Points">
    Determine where extensions can add intelligence. What information could be automated? What actions could be streamlined?
  </Accordion>
  <Accordion title="Build and Deploy">
    Create extensions that feel native to each site. Deploy through Chrome Web Store or enterprise distribution.
  </Accordion>
  <Accordion title="Scale Through Network Effects">
    Design features where each user's activity creates value for all users. Build competitive moats through user growth.
  </Accordion>
</AccordionGroup>

<Note>
  WithSeismic builds web extensions that transform passive browsing into active value creation. We create competitive advantages that compound with every user.
</Note>
