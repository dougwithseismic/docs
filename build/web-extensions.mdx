...
<Warning>
  **Indy.ai Case Study**: We turned Contra's user base into a distributed data
  ...
  browse. [Read the full case study →](/case-studies/contra-linkedin-automation)
</Warning>
...
<Tabs>
  ...
  <Tab title="The Magic">
    ...
    20,000 users = 20,000 perspectives - No central scraping required -
    Platform-compliant approach - Value multiplies with each user
  </Tab>
</Tabs>
