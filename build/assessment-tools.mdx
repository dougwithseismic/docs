...
<Card title="Build Your Assessment Tool" icon="rocket" href="/quickstart">
  Book Doug's 2-week sprint ($6K) or 4-week sprint ($12K) to transform your evaluation framework into a lead-generating assessment tool. 4-hour response time and immediate sprint planning.
</Card>