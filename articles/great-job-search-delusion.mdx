...
<script type="application/ld+json">{`
{
  ...
  "@type": "Article",
  "headline": "Why I'm Teaching Others How To Beat The Great Job Search Delusion",
  "description": "The traditional job application system is a statistical nightmare. Learn why the top-down approach generates 15-30% response rates instead of the typical 2%. Practical strategies from someone who's built successful businesses.",
  "author": {
    "@type": "Person",
    "name": "Doug Silkstone",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://withseismic.com/articles/great-job-search-delusion"
  },
  "articleSection": "Creator Resources",
  "keywords": ["job search", "career advice", "job applications", "networking", "career strategy", "job hunting tips"],
  "about": {
    "@type": "Thing",
    "name": "Job Search Strategy",
    "description": "Alternative approaches to traditional job applications for better response rates"
  }
}
`}</script>
