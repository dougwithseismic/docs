...
<AccordionGroup>
  <Accordion title="What size business actually benefits from programmatic acquisition?">
  ...
  <Accordion title="How do you shift from keyword-focused to problem-focused thinking?">
  ...
  <Accordion title="Why does programmatic targeting work better than competing on generic terms?">
  ...
  <Accordion title="What was the biggest technical breakthrough in the Toolzilla experiment?">
  ...
  <Accordion title="Why did direct-linking to marketplaces triple conversions?">
  ...
  <Accordion title="What's the 90-day cash flow trap and how do you avoid it?">
    Most affiliate programs pay commissions 90 days after transactions. If you scale spending from £200 to £10k monthly, you're funding three months of ad spend before seeing returns. This cash flow gap killed momentum at Vouchernaut and nearly caused bankruptcy. Have a plan: funding, patience, or both. You can't have neither.
  </Accordion>

  <Accordion title="How do you model realistic returns versus unrealistic projections?">
  ...
  <Accordion title="What's the difference between agency and systematic approaches?">
  ...
  <Accordion title="How do you know if you should attempt programmatic acquisition?">
  ...
  <Accordion title="What's the key decision point for implementing this approach?">
