...
<AccordionGroup>
  <Accordion title="🏝️ The Silo Trap" icon="island-tropical">
    **Problem**: Teams build in isolation. Appolica engineers boosted productivity 2x with AI tools but couldn't share gains company-wide.

    **Impact**: 70% of automation value trapped in individual teams
  ...
  <Accordion title="♻️ The Duplication Death Spiral" icon="recycle">
    **Problem**: Same solutions built repeatedly. One Fortune 500 built the same Slack integration 7 times.

    **Impact**: 5-10x wasted development effort
