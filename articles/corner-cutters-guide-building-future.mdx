...
<script type="application/ld+json">{`
{
  ...
  "@type": "Article",
  "headline": "The Corner Cutters' Guide: Principles I Try to Live By",
  "description": "How my approach to work has evolved over 15 years - from chasing quick wins to building things that matter. Lessons from bootstrapping a business to £10,000/month and selling it twice.",
  "author": {
    "@type": "Person",
    "name": "Doug Silkstone",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://withseismic.com/articles/corner-cutters-guide-building-future"
  },
  "articleSection": "Creator Resources",
  "keywords": ["entrepreneurship", "building businesses", "startup lessons", "founder mindset", "bootstrapping", "business principles"],
  "about": {
    "@type": "Thing",
    "name": "Entrepreneurial Principles",
    "description": "Lessons learned from 15 years of building and selling businesses"
  }
}
`}</script>
...
<AccordionGroup>
  <Accordion title="How has your approach to work evolved over your career?">
    After 15 years of building things, I've shifted from optimizing for speed and quick wins to focusing on work that compounds. Early career was about looking smart and moving fast; now it's about ensuring the work actually matters and creates long-term value. These principles aren't rules—they're guidelines I follow when I remember to.
  </Accordion>

  <Accordion title="What are the key principles for building meaningful products?">
    Focus on building things you'd actually use, leverage your unique advantages, ship early but not broken, and automate repetitive tasks. The core philosophy is prioritizing impact over activity. Every feature you don't build is a bug you don't have to fix and documentation you don't have to write.
  </Accordion>

  <Accordion title="Why is it important to build things you'd personally use?">
    Personal investment shows in the final product. Early in my career, I built whatever clients asked for. Now I only work on products I'd personally want to exist. It's a simple filter that saves everyone time and ensures authentic problem-solving rather than just feature implementation.
  </Accordion>

  <Accordion title="How do you identify and leverage your unique advantages?">
    I used to hide my generalist background, thinking I needed specialization. Being able to code, design, and understand business is actually my advantage. Whatever makes you different is probably your strength. I can prototype and ship entire products solo in a weekend—that's valuable, not normal.
  </Accordion>

  <Accordion title="What's the difference between shipping early and shipping broken?">
    Ship the smallest thing that provides real value, not just anything that technically works. The key question: "Would I be embarrassed if this was the only version that ever existed?" If yes, it needs more work. MVP doesn't mean "barely functional."
  </Accordion>

  <Accordion title="How do priorities shift as developers gain experience?">
    In your 20s you optimize for speed and looking smart, in your 30s for impact and sustainability, and eventually for meaningful work with people you enjoy. It's a shift from motion to progress. Life's too short for boring problems or difficult people.
  </Accordion>

  <Accordion title="Why focus on being intentional with effort rather than just working hard?">
    It's not about working less—it's about ensuring your work actually matters. Put maximum energy into what's important and minimum into everything else. The goal is making sure the work you do creates real value rather than just appearing busy.
  </Accordion>

  <Accordion title="Do these principles always work perfectly in practice?">
    No. I fail at them constantly—still overengineering, taking difficult clients for money, shipping things I'm not proud of. The point isn't perfection but having a north star to navigate by when you notice you're off course.
  </Accordion>

  <Accordion title="How should someone apply these principles to their own work?">
    Pick one principle that resonates, try it for a week, and adjust based on your reality. The best principles are ones you develop yourself through experience. These are just what I've learned so far—your lessons will be different.
  </Accordion>

  <Accordion title="What's the most important mindset shift for building meaningful products?">
    Move from optimizing for activity to optimizing for impact. Delete more than you add. Learn from what actually happens rather than what you planned. Trust your gut but verify with data. Make decisions reversible so you can move quickly without permanent consequences.
  </Accordion>
</AccordionGroup>
