...
<Card title="Build Your Onboarding Portal" icon="rocket" href="/quickstart">
  Book Doug's 2-week sprint ($6K) or 4-week sprint ($12K) to create streamlined onboarding portals that reduce admin overhead and improve client experience. 4-hour response time and immediate sprint planning.
</Card>