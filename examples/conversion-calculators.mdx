...
<Card title="Build Your Conversion Calculator" icon="rocket" href="/quickstart">
  Book Doug's 2-week sprint ($6K) or 4-week sprint ($12K) to create conversion calculators that quantify your value and convert prospects. 4-hour response time and immediate sprint planning.
</Card>