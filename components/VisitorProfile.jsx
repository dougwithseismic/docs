        ...
        <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-3">
          <div
            className={`h-3 rounded-full transition-all duration-500 ${
              profile.engagement?.level === 'qualified' ? 'bg-gradient-to-r from-yellow-500 to-yellow-600' :
              profile.engagement?.level === 'hot' ? 'bg-gradient-to-r from-orange-500 to-red-500' :
              profile.engagement?.level === 'warm' ? 'bg-gradient-to-r from-yellow-400 to-orange-400' :
              'bg-gradient-to-r from-blue-300 to-blue-400'
            }`}
            style={{ width: `${Math.min(((profile.engagement?.score || 0) / 5000) * 100, 100)}%` }}
          />
        </div>
      </div>
