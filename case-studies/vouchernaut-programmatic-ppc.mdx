...
{`{
  ...
  "url": "https://docs.withseismic.com/case-studies/vouchernaut-programmatic-ppc",
  "author": {
    "@type": "Person",
    "name": "Doug Silkstone",
...
I built a complete automation system that turned VoucherCloud's PPC operations into a growth engine. With PPC delivering 60% of affiliate revenue during expansion, it helped secure their position as a UK top 3 voucher site—culminating in Groupon's acquisition.

This evolved in two stages:

1. **Internal automation at VoucherCloud** to accelerate campaign creation
2. **Vouchernaut** — a fully automated, feed-based affiliate business running 100% of the funnel without human intervention
...
After VoucherCloud, I built Vouchernaut as a standalone system. Unlike simple campaign builders, Vouchernaut was a **fully automated affiliate engine**:
...
After VoucherCloud's success, Vouchernaut started as a personal experiment: "Can I do this for myself?" No grand business plan—just a promise that it would at least be a learning experience. The freedom to make decisions without stakeholder committees or watered-down compromises made it addictive.
