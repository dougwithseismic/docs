...
<div className="grid grid-cols-1 gap-4 mb-8">
  <video
    ...
    src="https://media.contra.com/video/upload/fl_progressive/q_auto:best,w_2000/k8nz0ewwce10olm7c1hh.mp4"
  />
  <video
    autoPlay
    muted
    ...
    playsInline
    className="w-full rounded-xl"
    src="https://media.contra.com/video/upload/fl_progressive/q_auto:best,w_2000/yni0olsetm4ipbfbi73p.mp4"
  />
  <video
    autoPlay
    muted
    ...
    playsInline
    className="w-full rounded-xl"
    src="https://media.contra.com/video/upload/fl_progressive/q_auto:best,w_2000/qjmnd12emndkcdez3jfe.mp4"
  />
</div>
