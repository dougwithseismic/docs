...
{`{
  ...
  "url": "https://docs.withseismic.com/case-studies/growthrunner-devtools",
  "author": {
    "@type": "Organization",
    "name": "WithSeismic"
  },
...
<img src="/images/growthrunner.png" alt="GrowthRunner DevTools Extension" className="rounded-lg" />

<Note>
[View the full case study on Contra →](https://contra.com/p/cbWXMPeN-bespoke-tools-growth-runner-devtools-extension)
</Note>
