...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
  <img
    ...
    src="https://media.contra.com/image/upload/fl_progressive/q_auto:best,w_1200/s3urkwkkrek8ui8khksc.webp"
    alt="STRV AI Chat Interface - Hero"
  />
  <img
    className="w-full rounded-xl"
    src="https://media.contra.com/image/upload/fl_progressive/q_auto:best,w_1200/jpirku5k0xtbjz5lvfh2.webp"
    alt="STRV AI Chat Interface - Conversation"
  />
  <img
    className="w-full rounded-xl"
    src="https://media.contra.com/image/upload/fl_progressive/q_auto:best,w_1200/jsds94cdmblqjisfmadi.webp"
    alt="STRV AI Chat Interface - Features"
  />
  <img
    className="w-full rounded-xl"
    src="https://media.contra.com/image/upload/fl_progressive/q_auto:best,w_1200/mxgumvalykfgoez5pjx3.webp"
    alt="STRV AI Chat Interface - Results"
  />
</div>
