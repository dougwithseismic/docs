...
<Cards>
  <Card
    ...
    icon="clock"
    href="https://cal.com/dougwithseismic/15min"
  >
    For quick questions or brief introductions
  </Card>

  <Card
    title="60-Minute Deep Dive"
    icon="microscope"
    href="https://cal.com/dougwithseismic/60min"
  >
    For detailed strategy sessions and planning
  </Card>
</Cards>
