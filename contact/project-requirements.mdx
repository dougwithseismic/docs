...
<AccordionGroup>
  ...
  <Accordion title="How do you determine if we're a good fit?">
    We look for three key factors: repetitive processes that eat significant time, willingness to adapt workflows for better results, and realistic budget for meaningful automation ($12K-25K). If any are missing, we'll be upfront about it.
  </Accordion>
