...
{`{
  ...
  "url": "https://docs.withseismic.com/contact/faq",
  "mainEntity": [
    {
      "@type": "Question",
...
Investment varies based on product complexity and scope:
- **Simple Tools:** $15K-30K (diagnostic tools, calculators)
- **Comprehensive Platforms:** $30K-75K (multi-feature products)
- **Enterprise Solutions:** $75K-150K (complex systems with integrations)
...
- **Break-even:** 4-6 months after launch
- **Year 1 Revenue:** $50K-200K from product sales
- **Year 2 Revenue:** $150K-500K with optimization
- **Service Revenue Impact:** 20-40% increase in service revenue due to lead generation and client qualification

ROI varies significantly based on market size, pricing strategy, and execution quality.
...
<Card title="Get Your Questions Answered" icon="rocket" href="/contact/book-consultation">
  Book a discovery call to get personalized answers and explore your productization opportunities.
</Card>
